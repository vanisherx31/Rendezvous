...
vR=[80 80];     %%%%%%%%% robot initial velocity vR in x and y direction
vRx=vR(1);
vRy=vR(2);
magvR=sqrt((vRx)^2+(vRy)^2);

magvT=10;    %%%%%%%%%%% defining target velocity vT magnitude and angle
thetaT=70;
...
vRTmaxx=vRT(1)+(magvrendmaxrel/dRT)*(rT(1));
vRTmaxy=vRT(2)+(magvrendmaxrel/dRT)*(rT(2));
